...
| Статистика и интеграции | `getStats`, `getAllWorkoutsSummary`, `getAllWorkoutsList`, `getRacePrediction`, `getIntegrationOAuthUrl`, `syncWorkouts`, `getIntegrationsStatus`, `unlinkIntegration`, `getStravaTokenError`, `getWorkoutTimeline` |
| Admin | `getAdminUsers`, `getAdminUser`, `updateAdminUser`, `deleteUser`, `getAdminSettings`, `updateAdminSettings`, `getAdminNotificationTemplates`, `updateAdminNotificationTemplate`, `resetAdminNotificationTemplate`, `getSiteSettings`, `getAiPlanMetrics`, `getAiPlanRecentEvents` |
...
| `src/api/statsApi.js` | `getStats`, `getAllWorkoutsSummary`, `getAllWorkoutsList`, `getRacePrediction`, `getIntegrationOAuthUrl`, `syncWorkouts`, `getIntegrationsStatus`, `unlinkIntegration`, `getStravaTokenError`, `getWorkoutTimeline` |
...
| `src/api/adminApi.js` | `getAdminUsers`, `getAdminUser`, `updateAdminUser`, `deleteUser`, `getAdminSettings`, `updateAdminSettings`, `getAdminNotificationTemplates`, `updateAdminNotificationTemplate`, `resetAdminNotificationTemplate`, `getSiteSettings`, `getAiPlanMetrics`, `getAiPlanRecentEvents` |
