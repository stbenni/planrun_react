    ...
    public static function getEventCatalog(): array {
        return [
            ...
            [
                'key' => 'coach',
                'label' => 'AI-тренер',
                'description' => 'Проактивные сообщения от AI-тренера',
                'events' => [
                    [
                        'event_key' => 'coach.proactive_post_workout_analysis',
                        'label' => 'Анализ тренировки',
                        'description' => 'AI-разбор после синхронизации тренировки',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_daily_briefing',
                        'label' => 'Утренний брифинг',
                        'description' => 'Ежедневная сводка от AI-тренера',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_weekly_digest',
                        'label' => 'Недельный дайджест',
                        'description' => 'Еженедельная сводка от AI-тренера',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_pause',
                        'label' => 'Пауза в тренировках',
                        'description' => 'Напоминание при длительном перерыве',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_overload',
                        'label' => 'Перегрузка',
                        'description' => 'Предупреждение о высокой нагрузке (ACWR)',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_overload_warning',
                        'label' => 'Предупреждение о нагрузке',
                        'description' => 'Нагрузка растёт, рекомендация снизить объём',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_race_approaching',
                        'label' => 'Приближается забег',
                        'description' => 'Напоминание перед соревнованием',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_low_compliance',
                        'label' => 'Низкое выполнение плана',
                        'description' => 'Мягкое предложение пересмотреть план',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_distance_record',
                        'label' => 'Рекорд дистанции',
                        'description' => 'Поздравление с новым рекордом',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_vdot_improvement',
                        'label' => 'Рост VDOT',
                        'description' => 'Улучшение показателя формы',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_volume_record',
                        'label' => 'Рекорд недельного объёма',
                        'description' => 'Поздравление с рекордным километражом',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_consistency_streak',
                        'label' => 'Стабильность тренировок',
                        'description' => 'Похвала за регулярные тренировки',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                    [
                        'event_key' => 'coach.proactive_goal_achievable',
                        'label' => 'Цель достижима',
                        'description' => 'Прогноз быстрее цели',
                        'channels' => self::CHANNEL_KEYS,
                    ],
                ],
            ],
    ...
    private function buildDefaultSettings(array $user): array {
        ...
        return [
            ...
            'preferences' => [
                ...
                // AI-тренер: проактивные уведомления
