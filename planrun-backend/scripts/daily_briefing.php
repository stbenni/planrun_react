...
<?php
/**
 * Утренний брифинг от AI-тренера.
 * Отправляет краткий план на сегодня пользователям с запланированной тренировкой.
 *
 * Cron: 0 7 * * * php /path/to/planrun-backend/scripts/daily_briefing.php
 */
...
try {
    ...
    $stats = $service->processDailyBriefings();
