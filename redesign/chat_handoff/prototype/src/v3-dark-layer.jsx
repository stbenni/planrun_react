...
[data-prdark="1"] [style*="rgba(255,255,255,0.5)"],
[data-prdark="1"] [style*="rgba(255, 255, 255, 0.5)"],
[data-prdark="1"] [style*="rgba(255,255,255,0.6)"],
[data-prdark="1"] [style*="rgba(255, 255, 255, 0.6)"],
[data-prdark="1"] [style*="rgba(255,255,255,0.7)"],
[data-prdark="1"] [style*="rgba(255, 255, 255, 0.7)"],
[data-prdark="1"] [style*="rgba(255,255,255,0.72)"],
[data-prdark="1"] [style*="rgba(255, 255, 255, 0.72)"],
[data-prdark="1"] [style*="rgba(255, 255, 255, 0.78)"],
[data-prdark="1"] [style*="rgba(255,255,255,0.78)"],
[data-prdark="1"] [style*="rgba(255,255,255,0.82)"],
[data-prdark="1"] [style*="rgba(255, 255, 255, 0.82)"],
...
/* Lighter washes (0.4-0.5) → semi-transparent dark */
[data-prdark="1"] [style*="rgba(255,255,255,0.4)"],
[data-prdark="1"] [style*="rgba(255, 255, 255, 0.4)"] {
  background-color: rgba(28, 34, 43, 0.3) !important;
  background-image: none !important;
}

/* ── Solid primary accents (active states) keep brand color ──── */
[data-prdark="1"] [style*="rgba(252,76,2,0.18)"],
[data-prdark="1"] [style*="rgba(252, 76, 2, 0.18)"] {
  background-color: rgba(252, 76, 2, 0.22) !important;
}

/* ── Pointer arrows (small triangles via rotate) ─────────────── */
[data-prdark="1"] [style*="transform: rotate(45deg)"][style*="rgba(255,255,255,0.78)"] {
  background-color: rgba(33, 41, 52, 0.92) !important;
}
